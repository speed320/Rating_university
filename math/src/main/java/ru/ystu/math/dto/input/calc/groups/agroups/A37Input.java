...
import ru.ystu.math.dto.input.calc.groups.agroups.param.AGroupInputA37;
import ru.ystu.math.dto.input.calc.groups.agroups.result.ResultAGroup;

@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, property = "type")
@JsonSubTypes({
        @JsonSubTypes.Type(value = AGroupInputA37.class, name = "paramData"),
        @JsonSubTypes.Type(value = ResultAGroup.class, name = "result")
})
public interface A37Input {
}
